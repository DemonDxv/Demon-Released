...
public class BlockUtil {
    ...
    public static Block getBlock(Location location) {
        if (Demon.getInstance().getBlockBoxManager().getBlockBox().isChunkLoaded(location)) {
    ...
    private static String[] HalfBlocksArray = {"pot", "flower", "step", "slab", "snow", "detector", "daylight",
    ...
    public static List<BoundingBox> getBlockBoundingBox(Block block) {
        List<BoundingBox> boxes = Demon.getInstance().getBlockBoxManager().getBlockBox().getSpecificBox(block.getLocation());
    ...
    public static List<Block> getBlocks(BoundingBox box, World world) {
        ...
        Demon.getInstance().getBlockBoxManager().getBlockBox().getCollidingBoxes(world, box).forEach(box2 -> BlockUtil.getBlock(box2.getMinimum().toLocation(world)));
        return block;
    }
